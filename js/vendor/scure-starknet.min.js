...
})()(
  {
    ...
    2: [
      function (require, module, exports) {
        ...
        function ensureBytes(hex) {
          return u.ensureBytes(
            "",
            typeof hex === "string" ? hex0xToBytes(hex) : hex
          );
        }
        ...
        function checkSignature(signature) {
          ...
          if (w < 0n || w >= exports.MAX_VALUE)
            throw new Error(
              `inv(Signature.s) should be [1, ${exports.MAX_VALUE})`
            );
        }
        ...
        function sign(msgHash, privKey, opts) {
          const sig = curve.sign(
            checkMessage(msgHash),
            normPrivKey(privKey),
            opts
          );
          checkSignature(sig);
        ...
        function grindKey(seed) {
          ...
          const limit =
            sha256mask - (0, modular_1.mod)(sha256mask, CURVE_ORDER);
          for (let i = 0; ; i++) {
            const key = sha256Num(
        ...
        function pedersenArg(arg) {
          ...
          if (!(0n <= value && value < curve.CURVE.Fp.ORDER))
            throw new Error(
              `PedersenArg should be 0 <= value < CURVE.P: ${value}`
            );
          return value;
        }
        ...
        function _poseidonMDS(Fp, name, m, attempt = 0) {
          ...
          for (let i = 0; i < m; i++) {
            x_values.push(
              poseidonRoundConstant(Fp, `${name}x`, attempt * m + i)
            );
            y_values.push(
              poseidonRoundConstant(Fp, `${name}y`, attempt * m + i)
            );
          }
      ...
      {
        "@noble/curves/_shortw_utils": 3,
        "@noble/curves/abstract/modular": 5,
        "@noble/curves/abstract/poseidon": 6,
        "@noble/curves/abstract/utils": 7,
        "@noble/curves/abstract/weierstrass": 8,
        "@noble/hashes/sha256": 14,
        "@noble/hashes/sha3": 15,
        "@noble/hashes/utils": 16
      }
    ],
    3: [
      function (require, module, exports) {
      ...
      {
        "./abstract/weierstrass.js": 8,
        "@noble/hashes/hmac": 13,
        "@noble/hashes/utils": 16
      }
    ],
    4: [
      ...
      {"./modular.js": 5, "./utils.js": 7}
    ],
    5: [
      function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {value: true});
        exports.mapHashToField =
          exports.getMinHashLength =
          exports.getFieldBytesLength =
          exports.hashToPrivateScalar =
          exports.FpSqrtEven =
          exports.FpSqrtOdd =
          exports.Field =
          exports.nLength =
          exports.FpIsSquare =
          exports.FpDiv =
          exports.FpInvertBatch =
          exports.FpPow =
          exports.validateField =
          exports.isNegativeLE =
          exports.FpSqrt =
          exports.tonelliShanks =
          exports.invert =
          exports.pow2 =
          exports.pow =
          exports.mod =
    ...
    6: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {value: true});
        exports.poseidon =
          exports.splitConstants =
          exports.validateOpts =
            void 0;
        const modular_js_1 = require("./modular.js");
        function validateOpts(opts) {
          ...
          for (const i of ["t", "roundsFull", "roundsPartial"]) {
            if (typeof opts[i] !== "number" || !Number.isSafeInteger(opts[i]))
              throw new Error(
                `Poseidon: invalid param ${i}=${opts[i]} (${typeof opts[i]})`
              );
          }
          ...
          if (rev !== undefined && typeof rev !== "boolean")
            throw new Error(
              `Poseidon: invalid param reversePartialPowIdx=${rev}`
            );
          if (roundsFull % 2 !== 0)
        ...
        function poseidon(opts) {
          ...
          const {Fp, mds, roundConstants, rounds, roundsPartial, sboxFn, t} =
            _opts;
          ...
          const poseidonRound = (values, isFull, idx) => {
            ...
            values = mds.map(i =>
              i.reduce(
                (acc, i, j) => Fp.add(acc, Fp.mulN(i, values[j])),
                Fp.ZERO
              )
            );
            return values;
          ...
          const poseidonHash = function poseidonHash(values) {
            if (!Array.isArray(values) || values.length !== t)
              throw new Error(
                `Poseidon: wrong values (expected array of bigints with length ${t})`
              );
            values = values.map(i => {
              if (typeof i !== "bigint")
            ...
            if (round !== rounds)
              throw new Error(
                `Poseidon: wrong number of rounds: last round=${round}, total=${rounds}`
              );
            return values;
          };
    ...
    8: [
      function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {value: true});
        exports.mapToCurveSimpleSWU =
          exports.SWUFpSqrtRatio =
          exports.weierstrass =
          exports.weierstrassPoints =
          exports.DER =
            void 0;
      ...
      {"./curve.js": 4, "./modular.js": 5, "./utils.js": 7}
    ],
    9: [
      function (require, module, exports) {
        "use strict";
    ...
    15: [
      function (require, module, exports) {
        ...
        const [SHA3_IOTA_H, SHA3_IOTA_L] = (0, _u64_js_1.split)(
          _SHA3_IOTA,
          true
        );
        const rotlH = (h, l, s) =>
          s > 32
            ? (0, _u64_js_1.rotlBH)(h, l, s)
            : (0, _u64_js_1.rotlSH)(h, l, s);
        const rotlL = (h, l, s) =>
          s > 32
            ? (0, _u64_js_1.rotlBL)(h, l, s)
            : (0, _u64_js_1.rotlSL)(h, l, s);
        ...
        const gen = (suffix, blockLen, outputLen) =>
          (0, utils_js_1.wrapConstructor)(
            () => new Keccak(blockLen, suffix, outputLen)
          );
        ...
        const genShake = (suffix, blockLen, outputLen) =>
          (0, utils_js_1.wrapXOFConstructorWithOpts)(
            (opts = {}) =>
              new Keccak(
                blockLen,
                suffix,
      ...
      {"./_assert.js": 9, "./_u64.js": 11, "./utils.js": 16}
    ],
    16: [
      function (require, module, exports) {
        "use strict";
      ...
      {"./_assert.js": 9, "@noble/hashes/crypto": 12}
    ]
  },
  {},
  [1]
